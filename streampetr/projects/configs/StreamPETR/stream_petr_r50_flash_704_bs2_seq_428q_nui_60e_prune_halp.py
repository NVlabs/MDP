...
model = dict(
    ...
    img_backbone=dict(
        init_cfg=dict(
            type='Pretrained', checkpoint="/workspace/alex/cascade_mask_rcnn_r50_fpn_coco-20e_20e_nuim_20201009_124951-40963960.pth",
            prefix='backbone.'),       
        type='ResNet',
        depth=50,
        num_stages=4,
...
# Use SyncBN for stability when requires_grad set to True
# SyncBN = True
# load_from="/workspace/alex/StreamPETR/test/reported_stream_petr_r50_flash_704_bs2_seq_428q_nui_60e.pth"
load_from="/workspace/alex/reported_stream_petr_r50_flash_704_bs2_seq_428q_nui_60e.pth"
resume_from=None
halp = True
# layer_mask = "/result/halppp_prune_70_longer/layer_masks.pkl"
# layer_mask = "/workspace/alex/layer_masks_halppp_imgnet_80.pkl"