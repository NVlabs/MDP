...
#            exit()
    ...
    def compute_saliency(self):
        ...
        dummy = [[[488, 22, 293, 68, 505, 4, 519, 332, 541, 425, 12, 254, 291, 97, 524, 277], 1e-10]]
        # 0
            # [488  22 293  68 505   4 519 332 541 425  12 254 291  97 524 277]
        # for layer, if_prune in enumerate(self.prune_layers):
        for layer in [0]:
            if_prune = True
            if not if_prune:
            ...
            import random
            selected_config = random.choice(list(range(len(cur_decision_vars_value))))
            print("Randomly selected pruning config:", selected_config)
...
if __name__ == '__main__':
    pass0 every neuron and running forward pass
        '''
