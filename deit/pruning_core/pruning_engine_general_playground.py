...
#            exit()
    ...
    def compute_saliency(self):
        ...
        if prune_count == 6:
            import pickle
            # with open("/workspace/alex/NViT/nvit/pre_compute_saliency.pkl", 'wb') as f:
            with open("/workspace/alex/NViT/nvit/after_prunes_pre_compute_saliency.pkl", 'wb') as f:
                pickle.dump(self, f)
            exit()
        ...
        print("Min", np.min(all_criteria))
        print("Max", np.max(all_criteria))
