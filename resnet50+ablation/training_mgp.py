...
from prune.latency_targeted_pruning_mgp import apply_latency_target_pruning
...
def train_loop(args, model, criterion, optimizer, lr_scheduler, train_loader, train_loader_len, val_loader, epochs, fp16,
    ...
    if method == 9 or method == 10 or method >= 20:  # latency aware pruning / latency targeted pruning
        ...
        from prune.latency_targeted_pruning_mgp import load_group_size
    ...
    if method >= 20:
        from prune.latency_targeted_pruning_mgp import set_latency_prune_target, get_total_latency
        # Done Change
        # print(layer_masks)
