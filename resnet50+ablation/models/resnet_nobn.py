...
def ResNet18(num_class=10, add_gate=False, **kwargs):
...
def ResNet34(num_class=10, add_gate=False, **kwargs):
...
def ResNet50(num_class=10, add_gate=False, **kwargs):
...
def ResNet101(num_class=10, add_gate=False, **kwargs):
...
def ResNet152(num_class=10, add_gate=False, **kwargs):
